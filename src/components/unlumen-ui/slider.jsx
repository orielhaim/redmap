...
const Slider = forwardRef((
  ...
  const fillWidthRange = useTransform([motionX0, motionX1], ([x0, x1]) => (x1) - (x0));
  const fillWidth = isRange ? fillWidthRange : fillWidthSingle;

  const computeHoverPreview = useCallback((cursorX, trackWidth) => {
    ...
    <div
      ...
      <div
        ...
        onMouseMove={(e) => {
          ...
          computeHoverPreview(Math.max(0, Math.min(trackRect.width, x)), trackRect.width);
        }}>
